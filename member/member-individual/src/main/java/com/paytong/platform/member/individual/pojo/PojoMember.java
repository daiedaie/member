 ...
 * 
 */
package com.paytong.platform.member.individual.pojo;
...
public  class PojoMember implements Serializable {
    ...
    @Type(type = "com.zlebank.zplatform.member.individual.pojo.usertype.RealNameLvSqlType")
    ...
    @Type(type = "com.zlebank.zplatform.member.individual.pojo.usertype.MemberSqlType")
    ...
    @Type(type = "com.zlebank.zplatform.member.individual.pojo.usertype.MemberStatusSqlType")
    @Column(name = "STATUS")
