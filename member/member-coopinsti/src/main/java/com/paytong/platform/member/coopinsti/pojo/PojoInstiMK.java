package com.paytong.platform.member.coopinsti.pojo;
...
public class PojoInstiMK implements Serializable{
    ...
    @Type(type = "com.zlebank.zplatform.member.coopinsti.pojo.usertype.TerminalAccessTypeSqlType")
    ...
    @Type(type = "com.zlebank.zplatform.member.coopinsti.pojo.usertype.EncryptAlgorithmSqlType")
