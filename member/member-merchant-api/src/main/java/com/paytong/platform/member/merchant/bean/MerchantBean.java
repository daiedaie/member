 ...
 * 
 */
package com.paytong.platform.member.merchant.bean;

import java.io.Serializable;
import java.util.Date;

import com.paytong.platform.member.merchant.bean.enums.CardType;
import com.paytong.platform.member.merchant.bean.enums.IndustryType;
import com.paytong.platform.member.merchant.bean.enums.MerchType;
